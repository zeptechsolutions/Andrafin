...
export const txLabels={income:'Ingreso',expense:'Gasto',extra:'Extra',transfer:'Transferencia',debt_payment:'Pago de deuda',loan_given:'Préstamo entregado',loan_repayment:'Cobro de préstamo',receivable_payment:'Dinero recibido'};
